...
CREATE TABLE stat.bunching (
    ...
    PRIMARE KEY (month, route_id, direction_id, stop_id, weekend, period)
);
...
CREATE TABLE stat.evt (
    ...
    PRIMARY KEY (month, route_id, direction_id, weekend, period)
);
...
CREATE TABLE stat.routeratio (
    ...
    shape_id text,
    routeratio numeric,
    PRIMARY KEY (feed_index, route_id, direction_id, shape_id)
);
CREATE TABLE stat.spacing(
    ...
    count_trip integer,
    wavg numeric,
    PRIMARY KEY (feed_index, route_id, direction_id)
);
